...
the_fit=fit_env(phylo=thetree,tot_time=max(node.age(thetree)$ages),
                env_data=real_temp_data,f.lamb=f.lamb,f.mu=f.mu,lamb_par=lamb_par,mu_par=mu_par,dt=1e-3)