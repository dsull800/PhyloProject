...
for(lambdas in list(2*exp(0.1*time_grid),0.2*time_grid+0.5,2*time_grid)){
...
genetreestuff=phybase::sim.coaltree.sp(rootnode,nodematrix[["nodes"]],nspecies,seq=rep(2,nspecies),
